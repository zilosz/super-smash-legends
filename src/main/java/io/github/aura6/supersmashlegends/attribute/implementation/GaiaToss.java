...
public class GaiaToss extends ChargedRightClickBlockAbility {
    ...
    public GaiaToss(SuperSmashLegends plugin, Section config, Kit kit) {
    ...
    private static class GaiaTossProjectile extends BlockProjectile {
        ...
        public GaiaTossProjectile(SuperSmashLegends plugin, Ability ability, Section config, boolean createParticles) {

...
public class MathUtils {
  ...
  public static double incVal(double min, double max, double rangeAtMax, double x) {
    return x * (max - min) / rangeAtMax + min;
  }

  public static double decVal(double min, double max, double rangeAtMin, double x) {
  ...
  public static Location ringPoint(
      Location center, float pitch, float yaw, double radius, double radians
  ) {

...
public class Barrage extends Bow {
    ...
    public void onStart() {
        ...
        this.stageTask = Bukkit.getScheduler().runTaskTimer(SSL.getInstance(), () -> {
            ...
            float pitch = (float) MathUtils.increasingValue(0.5, 2, this.getStages(), this.stage - 1);
    ...
    public void onShot(double force) {
        ...
        int amount = (int) MathUtils.increasingValue(1, arrowCount, this.getStages(), this.stage - 1);

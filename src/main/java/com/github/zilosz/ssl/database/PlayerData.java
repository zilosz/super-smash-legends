...
public class PlayerData {
    ...
    public PlayerData(
            ...
            @BsonProperty(value="inGameStats", useDiscriminator = true) InGameStats inGameStats,
            @BsonProperty(value="gameResultStats", useDiscriminator = true) GameResultStats gameResultStats
    ) {
        this.uuid = uuid;
        this.name = name;
